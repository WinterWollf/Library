...
def rent(list_user, list_book, rental_date_calendar, return_date_calendar, librarian_id, window):
    ...
    if return_date < rent_date:
        tkinter.messagebox.showinfo("Data error", "The return date cannot be earlier than the rental date!")
    elif count >= 1:
        tkinter.messagebox.showinfo("Data error", "The book you selected has already been borrowed!")
    elif list_user[0] == "":
        tkinter.messagebox.showinfo("Data error", "No reader selected!")
    elif list_book[0] == "":
        tkinter.messagebox.showinfo("Data error", "No book selected!")
    else:
        ...
        db.commit()
        tkinter.messagebox.showinfo("Announcement", "The book has been borrowed")
