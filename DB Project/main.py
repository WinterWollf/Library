...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\wikto\OneDrive\Pulpit\Bazy-Danych\DB Project\Assets\LoginPage")
...
def check_data():
    ...
    # Sprawdź, czy istnieje użytkownik o podanej nazwie użytkownika i haśle
    ...
    if user:
        ...
        # Wywołaj odpowiedni interfejs w zależności od tego, czy użytkownik jest bibliotekarzem, czy czytelnikiem
        if librarian_id is not None:
            print("Login successful!")

            window.destroy()

            # Utwórz nowe okno interfejsu
            new_window = Tk()
            ...
            print("Access denied")
            tkinter.messagebox.showinfo("Komunikat", "Błąd logowania do serwisu! Użyj strony studenta!")
        else:
            print("User is neither a librarian nor a reader.")
    else:
        tkinter.messagebox.showinfo("Błąd danych", "Wprowadzono błędne dane!")
...
window.title("Logowanie do systemu eAGH")
