...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\wikto\OneDrive\Pulpit\Bazy-Danych\DB Project\Assets\RaportPage")
...
def current_rented_books(window, librarian_id):
    ...
    # Zapytanie SQL do pobrania obecnie wypożyczonych książek
