...
COVER_PATH = OUTPUT_PATH / Path(r"C:\Users\wikto\OneDrive\Pulpit\Bazy-Danych\DB Project\Assets\BookSearch\Covers")
...
def back_to_serach_page(window, result, librarian_id, list_book, list_user):
    ...
    booksearch_3.show_search_page(new_window, result, librarian_id, list_book, list_user)
...
def show_book_overview(window, book_id, result, librarian_id, list_book, list_user):
    align_window(window)
    ...
    list_book_temporary = [title, author, publishing_house, book_id]
    ...
    button_1 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: return_date(window, librarian_id, list_book_temporary, list_user),
        relief="flat"
    )
    button_1.place(
        x=443.0,
